...
public final class About implements IVersionProvider {
    ...
    private static final String DOI = "10.5281/zenodo.18443266";
    private static final String COPYRIGHT = "Copyright (c) 2025-2026 held jointly by the individual authors.";
